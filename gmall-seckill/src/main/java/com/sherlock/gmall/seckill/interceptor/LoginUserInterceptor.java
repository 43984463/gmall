package com.sherlock.gmall.seckill.interceptor;
...
import com.sherlock.gmall.seckill.config.GmallSeckillWebConfiguration;
 ...
 *  2、 把拦截器添加到springMVC中
 *  @see GmallSeckillWebConfiguration#addInterceptors(org.springframework.web.servlet.config.annotation.InterceptorRegistry)
 *
...
public class LoginUserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        for (String whiteUrl : GmallSeckillConstant.SECKILL_REQUEST_WHITE_LIST) {
